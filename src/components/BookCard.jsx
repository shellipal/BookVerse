...
const BookCard = ({ book }) => {
  return (
    <div className="bg-gray-900 p-4 rounded-lg relative">
      ...
      <button className="absolute top-2 right-2 mt-2 bg-blue-700 p-2 rounded-lg text-lg font-semibold flex justify-center items-center gap-2 hover:bg-blue-600 transition cursor-pointer">
        <Heart size={18} />
      </button>
